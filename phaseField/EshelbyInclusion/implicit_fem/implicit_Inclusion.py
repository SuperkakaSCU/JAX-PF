...
class Inclusion(Problem):
    ...
    def get_tensor_map(self):
        ...
        def stress(u_grad, sol_u_old, eps0_diag):
            ...
            sigma = self.lam * np.trace(epsilon_ctr) * np.eye(self.dim) + 2*self.mu*epsilon_ctr
...
if __name__ == '__main__':
    ...
    print("This is implicit solver for Eshelby Inclusion:", end_time - start_time)
